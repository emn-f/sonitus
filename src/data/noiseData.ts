...
export const districtsList: DistrictInfo[] = [
  ...
  },
  {
    id: 'jardim-aurora',
    name: 'Jardim Aurora',
    tagline: 'Bairro residencial arborizado na zona norte',
  ...
  },
  {
    id: 'vila-serena',
    name: 'Vila Serena',
    tagline: 'Refúgio residencial com tráfego calmo na zona sul',
...
export const sensorsList: Sensor[] = [
  ...
  },
  {
    ...
    locationDesc: 'Alameda das Hortênsias, em frente à praça',
    position: { x: 18, y: 35 },
    status: 'online',
    firmware: 'v1.4.2-esp32',
    connectivity: 'LoRaWAN',
    ...
    readings: {
      ...
      Tarde: { decibels: 58, peakDb: 66, level: 'moderado', note: 'Atividade comunitária suave e entregas residenciais.' },
  ...
  },
  {
    ...
    readings: {
      ...
      Noite: { decibels: 46, peakDb: 52, level: 'tranquilo', note: 'Entorno silencioso e seguro para moradores e idosos.' },
    },
  },
  {
    id: 'SNS-011',
    name: 'Sensor Vila Serena / Travessa Sossego',
    districtId: 'vila-serena',
    districtName: 'Vila Serena',
    locationDesc: 'Fim de linha residencial sem saída',
    position: { x: 40, y: 84 },
    status: 'online',
    ...
    category: 'residencial',
    readings: {
      Manhã: { decibels: 46, peakDb: 53, level: 'tranquilo', note: 'Via estritamente local com tráfego desprezível.' },
...
export const sensitiveZonesList: SensitiveZone[] = [
  ...
  },
  {
    ...
    proximityToHeavyTraffic: 'Via residencial protegida',
  ...
  },
  {
    ...
    type: 'residencial_calmo',
    districtId: 'vila-serena',
    districtName: 'Vila Serena',
    isQuietOasis: true,
    targetLimitDb: 48,
    currentPeriodDb: { Manhã: 51, Tarde: 50, Noite: 46 },
    proximityToHeavyTraffic: 'Totalmente circunscrita por vias locais sem tráfego de ônibus',

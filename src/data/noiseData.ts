...
export const sensorsList: Sensor[] = [
  ...
  {
    id: 'SNS-013',
    name: 'Sensor Estação Cidadã do Centro',
    districtId: 'centro',
    districtName: 'Centro Histórico & Comercial',
    locationDesc: 'Marquise externa da estação de integração urbana',
    status: 'online',
    firmware: 'v1.4.3-esp32',
    connectivity: 'NB-IoT',
    batteryPercent: 95,
    powerSource: 'Rede Iluminação',
    lastTransmission: 'há 17s',
    category: 'comercial',
    readings: {
      Manhã: { decibels: 63, peakDb: 71, level: 'moderado', note: 'Embarques distribuídos e comércio de abertura mantêm um fluxo sonoro constante.' },
      Tarde: { decibels: 69, peakDb: 77, level: 'moderado', note: 'Integração de ônibus e comércio elevam a movimentação no início da tarde.' },
      Noite: { decibels: 54, peakDb: 63, level: 'tranquilo', note: 'Com menor frequência de linhas, o entorno volta a um patamar mais confortável.' },
    },
  },
  {
    id: 'SNS-014',
    name: 'Sensor Jardim Terapêutico Municipal',
    districtId: 'distrito-saude',
    districtName: 'Distrito Saúde & Bem-Estar',
    locationDesc: 'Entrada sombreada do jardim de pausa do complexo de saúde',
    status: 'online',
    firmware: 'v1.4.3-esp32',
    connectivity: 'LoRaWAN',
    batteryPercent: 90,
    powerSource: 'Solar + Li-ion',
    lastTransmission: 'há 21s',
    category: 'hospitalar',
    readings: {
      Manhã: { decibels: 47, peakDb: 55, level: 'tranquilo', note: 'Vegetação e recuo da via criam uma pausa acústica protegida para pacientes e acompanhantes.' },
      Tarde: { decibels: 51, peakDb: 60, level: 'tranquilo', note: 'Visitas e circulação interna suaves, ainda abaixo do limiar de atenção sensorial.' },
      Noite: { decibels: 40, peakDb: 47, level: 'tranquilo', note: 'Ambiente de baixa estimulação, adequado para recuperação e descanso.' },
    },
  },
  {
    id: 'SNS-015',
    name: 'Sensor Mirante do Lago',
    districtId: 'parque-verde',
    districtName: 'Parque das Águas & Área Verde',
    locationDesc: 'Deck oeste do lago, junto à trilha acessível',
    status: 'online',
    firmware: 'v1.4.2-esp32',
    connectivity: 'LoRaWAN',
    batteryPercent: 98,
    powerSource: 'Solar + Li-ion',
    lastTransmission: 'há 10s',
    category: 'parque',
    readings: {
      Manhã: { decibels: 42, peakDb: 49, level: 'tranquilo', note: 'Água, pássaros e cobertura vegetal predominam na paisagem sonora do mirante.' },
      Tarde: { decibels: 46, peakDb: 54, level: 'tranquilo', note: 'Caminhantes e famílias presentes, sem pressão sonora persistente.' },
      Noite: { decibels: 39, peakDb: 45, level: 'tranquilo', note: 'Um dos pontos mais silenciosos da malha urbana simulada.' },
    },
  },
  {
    id: 'SNS-016',
    name: 'Sensor Feira da Aurora',
    districtId: 'jardim-aurora',
    districtName: 'Jardim Aurora',
    locationDesc: 'Esquina da alameda principal com a feira comunitária',
    status: 'online',
    firmware: 'v1.4.1-esp32',
    connectivity: 'Wi-Fi Mesh',
    batteryPercent: 87,
    powerSource: 'Rede Iluminação',
    lastTransmission: 'há 26s',
    category: 'comercial',
    readings: {
      Manhã: { decibels: 55, peakDb: 64, level: 'moderado', note: 'Montagem de barracas e conversas locais geram movimento moderado e previsível.' },
      Tarde: { decibels: 57, peakDb: 66, level: 'moderado', note: 'Atividade comunitária amena, com picos breves durante a desmontagem.' },
      Noite: { decibels: 44, peakDb: 51, level: 'tranquilo', note: 'Após a feira, a alameda volta a ter circulação leve e silenciosa.' },
    },
  },
  {
    id: 'SNS-017',
    name: 'Sensor Bosque das Acácias',
    districtId: 'vila-serena',
    districtName: 'Vila Serena',
    locationDesc: 'Entrada sul do bosque, próxima à rota de caminhada',
    status: 'online',
    firmware: 'v1.4.3-esp32',
    connectivity: 'LoRaWAN',
    batteryPercent: 93,
    powerSource: 'Solar + Li-ion',
    lastTransmission: 'há 13s',
    category: 'parque',
    readings: {
      Manhã: { decibels: 45, peakDb: 52, level: 'tranquilo', note: 'Percurso arborizado com pouca reverberação e fluxo reduzido de veículos.' },
      Tarde: { decibels: 49, peakDb: 56, level: 'tranquilo', note: 'Boa opção para descanso sensorial entre compromissos no bairro.' },
      Noite: { decibels: 41, peakDb: 47, level: 'tranquilo', note: 'Cobertura vegetal e vias locais preservam a sensação de calma noturna.' },
    },
  },
  {
    id: 'SNS-018',
    name: 'Sensor Terminal Leste',
    districtId: 'eixo-leste',
    districtName: 'Eixo Leste / Mobilidade',
    locationDesc: 'Plataforma externa de integração com corredor viário',
    status: 'online',
    firmware: 'v1.4.3-esp32',
    connectivity: 'NB-IoT',
    batteryPercent: 97,
    powerSource: 'Rede Iluminação',
    lastTransmission: 'há 7s',
    category: 'arterial',
    readings: {
      Manhã: { decibels: 70, peakDb: 79, level: 'moderado', note: 'Chegada de ônibus e acelerações pontuais tornam o terminal uma área de atenção.' },
      Tarde: { decibels: 76, peakDb: 85, level: 'intenso', note: 'Pico de integração no corredor leste; prefira proteção auditiva e rotas alternativas.' },
      Noite: { decibels: 58, peakDb: 67, level: 'moderado', note: 'Fluxo diminui, mas partidas intermunicipais mantêm ruído mecânico perceptível.' },
    },
  },
]
 ...
 * porém populada dinamicamente a partir dos 18 sensores modelados.
 */
